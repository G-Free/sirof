                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills navtab-bg nav-justified">
                            ...
                            <li class="nav-item">
                                <a href="#envolvidos" data-bs-toggle="tab" aria-expanded="true" class="nav-link">
                                    Envolvidos({{ $ocorrencia->envolvidos->count() }})
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#infraccoes" data-bs-toggle="tab" aria-expanded="false" class="nav-link">
                                    @php
                                        ...
                                        foreach($ocorrencia->envolvidos as $envolvido){
                                            $infraccoesCount += $envolvido->infraccoes->count();
                                        }
                                    @endphp
                                    Infracções ({{ $infraccoesCount }})
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#finalizar_ocorrencia" data-bs-toggle="tab" aria-expanded="false" class="nav-link">
                                    Finalizar
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane tab-pane fade" id="ocorrencia">
                                ...
                                @include('frontoffice.ocorrencia.edit_ocorrencia')                            
                            ...
                            {{-- TAB FINALIZAR --}}
                            <div class="tab-pane" id="finalizar_ocorrencia">
                                
                                @include('frontoffice.ocorrencia.finalizar_ocorrencia')                              
