...
<html lang="en" data-layout="horizontal" data-topbar-color="dark">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Dashboard | Sirof</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="SIROF = Sistema Integrado de Registro de Ocorrências Fronteiriças" name="description" />
        <meta content="SIROF" name="author" />
        <meta name="csrf-token" content="{{ csrf_token() }}">

        <!-- App favicon -->
        <link rel="shortcut icon" href="{{ asset('frontoffice/assets/images/favicon.ico') }}">

        <!-- Plugins css -->
        {{--<link href="{{ asset('frontoffice/assets/libs/flatpickr/flatpickr.min.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('frontoffice/assets/libs/selectize/css/selectize.bootstrap3.css') }}" rel="stylesheet" type="text/css" />--}}
        
        <!-- Theme Config Js -->
        <script src="{{ asset('frontoffice/assets/js/head.js') }}"></script>

        <!-- Bootstrap css -->
        <link href="{{ asset('frontoffice/assets/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" id="app-style" />

        <!-- App css -->
        <link href="{{ asset('frontoffice/assets/css/app.min.css') }}" rel="stylesheet" type="text/css" />

        <!-- Icons css -->
        <link href="{{ asset('frontoffice/assets/css/icons.min.css') }}" rel="stylesheet" type="text/css" />
...
<style>
     ...
     :root {
        ...
        --wizard-step-size: 64px;
        --wizard-step-font-size: 24px;
    } 
/*
    :root {
        --wizard-color-neutral:  #989ca3;
        --wizard-color-active:   #3b3d40;
        --wizard-color-complete: #3b3d40;
        --wizard-step-size: 64px;
        --wizard-step-font-size: 24px;
    }*/
    ...
    button {
        padding: 8px 18px;
        border: none;
        /*background: var(--wizard-color-active);*/
        background: #4183d7;
        color: #fff;
        cursor: pointer;
        margin-left: 10px;
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <!-- Layout -->
            <!-- ========== Left Sidebar Start ========== -->
            <div class="app-menu" style="border-bottom: 1px solid rgba(0, 0, 0, 0.093);">

                <!-- Brand Logo -->
                <div class="logo-box">
                    <!-- Brand Logo Light -->
                    <a href="index.html" class="logo-light">
                        <img src="{{ asset('frontoffice/assets/images/logo-light.png') }}" alt="logo" class="logo-lg">
                        <img src="{{ asset('frontoffice/assets/images/logo-sm.png') }}" alt="small logo" class="logo-sm">
                    </a>

                    <!-- Brand Logo Dark -->
                    <a href="index.html" class="logo-dark">
                        <img src="{{ asset('frontoffice/assets/images/logo-dark.png') }}" alt="dark logo" class="logo-lg">
                        <img src="{{ asset('frontoffice/assets/images/logo-sm.png') }}" alt="small logo" class="logo-sm">
                    </a>
                </div>

                <div class="container text-center">
                    <h5 class="text-dark">- Sistema Integrado de Registo de Ocorrências Fronteiriças (SIROF) - Posto Fronteiriço do Luvo -</h5>
                </div>
                
                <!--- Menu -->
                
                {{-- @include('frontoffice.body.menu')--}}
            ...
            <div class="content-page">
                ...
                @include('frontoffice.body.header')
                ...
                <!-- Footer Start -->
                @include('frontoffice.body.footer')
                <!-- end Footer -->
                    ...
                    <div class="tab-pane" id="chat-tab" role="tabpanel">
                        ...
                        <div>
                            <a href="javascript: void(0);" class="text-reset notification-item">
                                <div class="d-flex align-items-start noti-user-item">
                                    <div class="position-relative me-2">
                                        <img src="{{ asset('frontoffice/assets/images/users/user-10.jpg')}}" class="rounded-circle avatar-sm" alt="user-pic">
                            ...
                            <a href="javascript: void(0);" class="text-reset notification-item">
                                <div class="d-flex align-items-start noti-user-item">
                                    <div class="position-relative me-2">
                                        <img src="{{ asset('frontoffice/assets/images/users/user-1.jpg')}}" class="rounded-circle avatar-sm" alt="user-pic">
                            ...
                            <a href="javascript: void(0);" class="text-reset notification-item">
                                <div class="d-flex align-items-start noti-user-item">
                                    <div class="position-relative me-2">
                                        <img src="{{ asset('frontoffice/assets/images/users/user-9.jpg')}}" class="rounded-circle avatar-sm" alt="user-pic">
                        ...
                        <div class="pb-4">
                            <a href="javascript: void(0);" class="text-reset notification-item">
                                <div class="d-flex align-items-start noti-user-item">
                                    <div class="position-relative me-2">
                                        <img src="{{ asset('frontoffice/assets/images/users/user-2.jpg')}}" class="rounded-circle avatar-sm" alt="user-pic">
                                        <i class="mdi mdi-circle user-status online"></i>
                                    </div>
                                    <div class="overflow-hidden">
                            ...
                            <a href="javascript: void(0);" class="text-reset notification-item">
                                <div class="d-flex align-items-start noti-user-item">
                                    <div class="position-relative me-2">
                                        <img src="{{ asset('frontoffice/assets/images/users/user-4.jpg')}}" class="rounded-circle avatar-sm" alt="user-pic">
                                        <i class="mdi mdi-circle user-status away"></i>
                                    </div>
                                    <div class="overflow-hidden">
                            ...
                            <a href="javascript: void(0);" class="text-reset notification-item">
                                <div class="d-flex align-items-start noti-user-item">
                                    <div class="position-relative me-2">
                                        <img src="{{ asset('frontoffice/assets/images/users/user-5.jpg')}}" class="rounded-circle avatar-sm" alt="user-pic">
                                        <i class="mdi mdi-circle user-status online"></i>
                                    </div>
                                    <div class="overflow-hidden">
                            ...
                            <a href="javascript: void(0);" class="text-reset notification-item">
                                <div class="d-flex align-items-start noti-user-item">
                                    <div class="position-relative me-2">
                                        <img src="{{ asset('frontoffice/assets/images/users/user-6.jpg')}}" class="rounded-circle avatar-sm" alt="user-pic">
                                        <i class="mdi mdi-circle user-status online"></i>
                                    </div>
                                    <div class="overflow-hidden">
                            ...
                            <a href="javascript: void(0);" class="text-reset notification-item">
                                <div class="d-flex align-items-start noti-user-item">
                                    <div class="position-relative me-2">
                                        <img src="{{ asset('frontoffice/assets/images/users/user-7.jpg')}}" class="rounded-circle avatar-sm" alt="user-pic">
                                        <i class="mdi mdi-circle user-status busy"></i>
                                    </div>
                                    <div class="overflow-hidden">
                            ...
                            <a href="javascript: void(0);" class="text-reset notification-item">
                                <div class="d-flex align-items-start noti-user-item">
                                    <div class="position-relative me-2">
                                        <img src="{{ asset('frontoffice/assets/images/users/user-8.jpg')}}" class="rounded-circle avatar-sm" alt="user-pic">
                                        <i class="mdi mdi-circle user-status away"></i>
                                    </div>
                                    <div class="overflow-hidden">
        ...
        <!-- App js -->
        <script src="{{ asset('frontoffice/assets/js/app.min.js')}}"></script>
        
        <!-- Plugins js-->
        {{--
            <script src="{{ asset('frontoffice/assets/libs/flatpickr/flatpickr.min.js')}}"></script>
            <script src="{{ asset('frontoffice/assets/libs/apexcharts/apexcharts.min.js')}}"></script>
            <script src="{{ asset('frontoffice/assets/libs/selectize/js/standalone/selectize.min.js')}}"></script>
        --}}

        <!-- Dashboar 1 init js-->
        {{--<script src="{{ asset('frontoffice/assets/js/pages/dashboard-1.init.js')}}"></script>--}}

        <!-- Footable js -->
        <script src="{{ asset('frontoffice/assets/libs/footable/footable.all.min.js') }}"></script>

        <!-- Init js -->
        <script src="{{ asset('frontoffice/assets/js/pages/foo-tables.init.js') }}"></script>
        
        <script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script> 
        <script src="{{ asset('frontoffice/assets/js/code.js') }}"></script>
        <script src="{{ asset('frontoffice/assets/js/validate.min.js') }}"></script>
